        ...
        <form:form method="post" commandName="model">
            <div class="container">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><span class="glyphicon glyphicon-blackboard"></span> &nbsp;&nbsp;Ingresar aula</div>
                            ...
                            <div class="well">  
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-barcode"></span></span>
                                                <form:input class="form-control" path="pc"/>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <form:errors path="pc" cssClass="error"/>
                                    </div>
                                </div>

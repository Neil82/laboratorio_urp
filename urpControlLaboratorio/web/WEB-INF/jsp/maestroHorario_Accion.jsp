...
<table class="table table-hover">
    ...
    <c:forEach items="${model.horarios}" var="horario">
        ...
        <c:set var="rep_viernes_doc" value="${horario.rep_viernes_docente}" /> 
        ...
        <tr>
            <td><c:out value="${rep_horaInicio}"/></td>
            <td><c:out value="${rep_horaFin}"/></td>
            <td><c:out value="${rep_lunes}"/></td>
            <td><c:out value="${rep_martes}"/></td>
            <td><c:out value="${rep_miercoles}"/></td>
            <td><c:out value="${rep_jueves}"/></td>
            <td><c:out value="${rep_viernes}"/></td>
            <td><c:out value="${rep_sabado}"/></td>
